...
// No per-file size cap — the bridge runs on the user's own machine.
// Transport is base64-in-JSON over WebSocket; memory is the only
// practical limit, and that's the user's concern, not ours.
