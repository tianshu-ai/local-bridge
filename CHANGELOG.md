...
## [0.7.4](https://github.com/tianshu-ai/local-bridge/compare/v0.12.5...v0.7.4) (2026-09-13)
...
* add read_file and write_file native tools ([#39](https://github.com/tianshu-ai/local-bridge/issues/39)) ([8a7d15a](https://github.com/tianshu-ai/local-bridge/commit/8a7d15a5f165952dfed6fd6146e41cc4db5bfe79))
...
* **log:** rolling-file log tee under ~/.tianshu-bridge/logs ([928acf3](https://github.com/tianshu-ai/local-bridge/commit/928acf3f4ae99ecafe7767d98e6a17f329be3884))
...
* use login shell (bash -l -c) for full user PATH ([6c3e6bd](https://github.com/tianshu-ai/local-bridge/commit/6c3e6bde5ff11b549c84d7b4bb46b31ca04f2fbe))
...
* use user's default shell (SHELL) with -l -i to load .bashrc/.zshrc ([d5ccb49](https://github.com/tianshu-ai/local-bridge/commit/d5ccb49603c055b499e0f34d102a53158df74ccd))
